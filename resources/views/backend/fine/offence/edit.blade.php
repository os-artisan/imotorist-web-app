...
@section ('title', trans('labels.backend.fine.offences.management') . ' | ' . trans('labels.backend.fine.offences.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.fine.offences.management') }}
        <small>{{ trans('labels.backend.fine.offences.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($offence, ['route' => ['admin.fine.offence.update', $offence], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.fine.offences.edit') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('description_si', trans('validation.attributes.backend.fine.offences.description_si'),
                    ['class' => 'col-lg-2 control-label required']) }}

                    <div class="col-lg-10">
                        {{ Form::text('description_si', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => trans('validation.attributes.backend.fine.offences.description_si')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
